...
joblib.dump(regression_model, 'metals_regression_model.joblib', compress=3)
joblib.dump(elasticity_classifier, 'metals_elasticity_classifier.joblib', compress=3)
joblib.dump(scaler, 'metals_scaler.joblib', compress=3)
joblib.dump(bulk_model, 'metals_bulk_model.joblib', compress=3)
joblib.dump(shear_model, 'metals_shear_model.joblib', compress=3)